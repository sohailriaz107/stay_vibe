    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-9">
                ...
                <div class="row g-3">
                    <div class="col-lg-6">
                        <div class="premium-card p-3 px-2 px-sm-4 py-sm-4 bg-white border-0 shadow-sm h-100" style="border-radius: 20px;">
                            <h5 class="fw-bold mb-4 text-center" style="font-size: 1.1rem;">Withdrawal Form</h5>
                            <form action="" method="POST" id="withdrawForm">
                                <input type="hidden" name="csrf_token" value="<?php echo generate_csrf_token(); ?>">
                                
                                <div class="bg-light p-3 rounded-4 mb-4 text-center" style="border: 1px solid rgba(0,0,0,0.02);">
                                    <label class="form-label small fw-bold text-muted mb-1" style="font-size: 0.75rem; letter-spacing: 0.5px;">Available Balance</label>
                                    <div class="h2 fw-extrabold text-primary mb-0" style="font-weight: 800;">₹<?php echo number_format($balance, 2); ?></div>
                                    <?php if(!$three_months_passed && $balance > $max_withdrawable): ?>
                                        <div class="small text-danger mt-2 fw-bold" style="font-size: 0.75rem;"><i class="fas fa-lock me-1"></i> Rental income is locked for 3 months.</div>
                                        <div class="small text-success mt-1 fw-semibold" style="font-size: 0.72rem;"><i class="fas fa-check-circle me-1"></i> Max withdrawable (Referrals only): ₹<?php echo number_format($max_withdrawable, 2); ?></div>
                                    <?php endif; ?>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label small fw-bold text-secondary mb-2" style="font-size: 0.8rem;">Withdrawal Amount</label>
                                    <div class="input-group">
                                        <span class="input-group-text border-0 bg-light fw-bold text-muted">₹</span>
                                        <input type="number" name="amount" id="withdrawAmount" class="form-control form-control-lg bg-light border-0 fw-bold" placeholder="Enter amount" required style="font-size: 1.1rem;">
                                    </div>
                                    <p class="text-muted small mt-2 mb-0" style="font-size: 0.75rem; line-height: 1.35;">Note: Min. ₹5,000 for Rental. <span class="text-success fw-bold">No minimum limit for Referral Earnings!</span> (10% fee applies)</p>
                                </div>
                                
                                <div class="p-3 rounded-4 mb-4" style="background: rgba(201, 162, 39, 0.03); border: 1px dashed rgba(201, 162, 39, 0.25);">
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="small text-muted" style="font-size: 0.78rem;">Processing Fee (10%)</span>
                                        <span class="small fw-bold text-danger" id="feeDisplay" style="font-size: 0.78rem;">₹0.00</span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="fw-bold text-dark" style="font-size: 0.88rem;">Final Payout Amount</span>
                                        <span class="fw-extrabold text-success" id="finalDisplay" style="font-size: 0.88rem; font-weight: 800;">₹0.00</span>
                                    </div>
                                </div>

                                <div class="text-center mt-4">
                                    <button type="submit" name="request_withdrawal" class="btn btn-gold btn-sm px-4 py-2.5 fw-bold rounded-pill <?php echo !$kyc_verified ? 'disabled' : ''; ?>" style="font-size: 13px; min-width: 220px; max-width: 100%;">
                    ...
                    <div class="col-lg-6">
                        <div class="premium-card p-3 px-2 px-sm-4 py-sm-4 bg-white border-0 shadow-sm h-100" style="border-radius: 20px;">
                            <h5 class="fw-bold mb-4 text-center" style="font-size: 1.1rem;">Important Guidelines</h5>
                    ...
                    <div class="col-lg-12">
                        <div class="premium-card p-3 px-2 px-sm-4 py-sm-4 bg-white border-0 shadow-sm mt-4" style="border-radius: 20px;">
                            <h5 class="fw-bold mb-4 text-center">Withdrawal History</h5>
