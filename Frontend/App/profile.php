                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-12">
                        <div class="premium-card p-3 px-2 px-sm-4 py-sm-4 bg-white border-0 shadow-sm" style="border-radius: 20px;">
                            <h5 class="fw-bold mb-4 text-center"><i class="fas fa-user-edit me-2 text-primary"></i> Personal Details</h5>
                            <form action="" method="POST">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 mt-4 text-center">
                                        <button type="submit" name="update_profile" class="btn btn-gold btn-sm px-4 py-2 fw-bold rounded-pill shadow-sm" style="min-width: 220px; max-width: 100%; font-size: 13px;">Update Details</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="premium-card p-4 bg-white border-0 shadow-sm mb-3" style="border-radius: 20px;">
                    ...
                    <!-- Account Session Control (Logout) -->
                    <div class="col-lg-12">
                        <div class="premium-card p-4 bg-white border-0 shadow-sm mb-4" style="border-radius: 20px;">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                                <div>
                                    <h5 class="fw-bold mb-1 text-nowrap text-danger"><i class="fas fa-sign-out-alt me-2"></i> Account Session</h5>
                                    <p class="text-muted small mb-0">Sign out of your active session on this device.</p>
                                </div>
                                <div class="text-center text-md-end w-100 w-md-auto">
                                    <a href="../pages/logout.php" class="btn btn-outline-danger px-4 rounded-pill text-nowrap fw-bold" onclick="return confirm('Are you sure you want to logout?');">
