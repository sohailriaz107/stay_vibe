    ...
    <div class="container">
        <div class="row gx-2 gx-sm-3 gy-3 gy-sm-4 justify-content-center">
            ...
            while ($plan_db = $result->fetch_assoc()) {
                ...
                $secure_text = ($plan_db['physical_land'] || strpos($name, 'Plan D') !== false || strpos($name, 'Plan E') !== false) ? 'Secured with Physical Land (Plot Registry)' : false;
            ?>
            <div class="<?php echo $col_class; ?> col-md-6 px-2 px-sm-3">
                <div class="premium-card h-100 border-0 shadow-sm position-relative overflow-hidden" style="background: white; border-top: 5px solid <?php echo $color; ?> !important; border-radius: 24px;">
                    <?php if($plan_db['physical_land'] || strpos($name, 'Plan D') !== false || strpos($name, 'Plan E') !== false) { ?>
                    ...
                    <div class="p-3 p-sm-5">
                        ...
                        <ul class="list-unstyled mb-3 mb-sm-5">
                ...
                <div class="premium-card p-3 p-md-4 bg-white border-0 shadow-sm h-100" style="border-radius: 20px;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered align-middle text-center small mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="fw-bold py-2">₹21,000</td>
                                    <td>₹8,400</td>
                                    <td>₹6,300</td>
                                    <td>₹6,300</td>
                                </tr>
                                <tr>
                                    <td class="fw-bold py-2">₹39,999</td>
                                    <td>₹16,000</td>
                                    <td>₹12,000</td>
                                    <td>₹12,000</td>
                                </tr>
                                <tr>
                                    <td class="fw-bold py-2">₹79,999</td>
                                    <td>₹32,000</td>
                                    <td>₹24,000</td>
                                    <td>₹24,000</td>
                                </tr>
                ...
                <div class="premium-card p-3 p-md-4 bg-white border-0 shadow-sm h-100" style="border-radius: 20px;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered align-middle text-center small mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="fw-bold py-2">₹6,25,000</td>
                                    <td>₹1,25,000</td>
                                    <td>₹1,25,000</td>
                                    <td>₹3,75,000</td>
                                </tr>
                                <tr>
                                    <td class="fw-bold py-2">₹12,50,000</td>
                                    <td>₹2,50,000</td>
                                    <td>₹2,50,000</td>
                                    <td>₹7,50,000</td>
                                </tr>
