        ...
        <div class="row g-4">
            ...
            <div class="col-lg-9">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-lg-7">
                        <div class="premium-card p-4 bg-white border-0 shadow-sm h-100">
                            ...
                            <p class="text-muted small mb-4">Share this unique link with your network. When they register and activate a plan, you will automatically receive your commission.</p>
                            
                            <div class="input-group mb-3">
                                <input type="text" class="form-control bg-light border-0 fw-bold text-primary" id="refLink" value="<?php echo htmlspecialchars($base_url); ?>" readonly>
                    ...
                    <!-- Earnings Summary -->
                    <div class="col-lg-5">
                        <div class="premium-card p-4 border-0 shadow-sm h-100 text-white" style="background: linear-gradient(135deg, var(--primary-color), #1a2533) !important;">
                            <h6 class="text-white-50 small mb-3 text-uppercase letter-spacing-1">Total Referral Earnings</h6>
                            <h1 class="fw-bold mb-3 text-white">₹<?php echo number_format($referral_earnings, 2); ?></h1>
                            
                            <div class="p-3 bg-white bg-opacity-10 rounded-3 mt-auto">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="small">Your Commission Rate</span>
                                    <span class="badge bg-gold text-dark fs-6"><?php echo $commission_rate; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="premium-card p-4 bg-white border-0 shadow-sm">
                    <h5 class="fw-bold mb-4">Your Network History</h5>
