    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="row g-4">
                ...
                <div class="col-lg-7">
                    <div class="premium-card p-5 bg-white border-0 shadow-sm mb-4" style="border-radius: 25px;">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                <div class="p-3 rounded-3 bg-light text-center">
                                    <div class="small text-muted mb-1">Rental Income</div>
                                    <div class="fw-bold"><?php echo $plan_rental; ?> / Yr</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 rounded-3 bg-light text-center">
                                    <div class="small text-muted mb-1">Referral Bonus</div>
                                    <div class="fw-bold"><?php echo $plan_referral; ?></div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 rounded-3 bg-light text-center">
                                    <div class="small text-muted mb-1">Free Stay</div>
                                    <div class="fw-bold"><?php echo $plan_stay; ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-primary text-white p-4 rounded-4 shadow-sm mb-4">
                            <div class="row g-3">
                                <div class="col-6">
                                    <div class="x-small-text opacity-75">Account Name</div>
                                    <div class="fw-bold">STAY VIBES RESORT PVT LTD</div>
                                </div>
                                <div class="col-6">
                                    <div class="x-small-text opacity-75">Bank Name</div>
                                    <div class="fw-bold">HDFC BANK</div>
                                </div>
                                <div class="col-6">
                                    <div class="x-small-text opacity-75">Account Number</div>
                                    <div class="fw-bold">50200088997766</div>
                                </div>
                                <div class="col-6">
                                    <div class="x-small-text opacity-75">IFSC Code</div>
                                    <div class="fw-bold">HDFC0001234</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="premium-card p-5 bg-white border-0 shadow-lg sticky-top" style="border-radius: 25px; top: 100px;">
                        <h4 class="fw-bold mb-4 text-center">Submit Proof</h4>
                        <?php echo $message; ?>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label class="form-label small fw-bold">Select Installment Amount</label>
                                <select name="payment_amount" class="form-select border-0 bg-light py-3" required>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="payment_method" class="form-select border-0 bg-light py-3" required>
                            ...
                            <div class="mb-4">
                                <label class="form-label small fw-bold">Transaction ID / UTR Number</label>
                                <input type="text" name="utr_number" class="form-control border-0 bg-light py-3" placeholder="Enter 12-digit UTR" required>
                            </div>

                            <div class="mb-4">
                                <label class="form-label small fw-bold">Upload Payment Screenshot</label>
                                <div class="upload-area p-4 rounded-4 text-center bg-light border-dashed border-2 position-relative" style="border: 2px dashed #dee2e6;">
                                    ...
                                    <label for="fileInput" id="uploadLabel" class="mb-0 cursor-pointer w-100" style="cursor: pointer;">
                                        ...
                                        <div class="fw-bold text-primary">Click to Upload</div>
                            ...
                            <button type="submit" name="submit_payment" class="btn btn-primary btn-lg w-100 py-3 fw-bold rounded-pill shadow-sm">Submit Payment Proof</button>
