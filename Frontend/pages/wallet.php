        ...
        <div class="row g-4">
            ...
            <div class="col-lg-9">
                ...
                <div class="row g-4 mb-5">
                    <!-- Balance Cards -->
                    <div class="col-md-4">
                        <div class="premium-card p-4 bg-primary text-white border-0 shadow-sm h-100" style="border-radius: 20px;">
                            <h6 class="text-white-50 small mb-2">Available for Withdrawal</h6>
                            <h2 class="fw-bold mb-0">₹<?php echo number_format($balance, 2); ?></h2>
                            <hr class="border-white opacity-25">
                            <a href="withdraw.php" class="btn btn-gold btn-sm w-100 rounded-pill py-2 text-dark fw-bold">Withdraw Funds</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="premium-card p-4 bg-white border-0 shadow-sm h-100" style="border-radius: 20px;">
                            <h6 class="text-muted small mb-2">Locked Balance (Principal)</h6>
                            <h2 class="fw-bold mb-0">₹<?php echo number_format($locked_balance, 2); ?></h2>
                            <p class="text-muted small mt-2 mb-0">Unlocks after 3 years.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="premium-card p-4 bg-white border-0 shadow-sm h-100" style="border-radius: 20px;">
                            <h6 class="text-muted small mb-2">Total Earnings History</h6>
                            <h2 class="fw-bold mb-0 text-success">₹<?php echo number_format($total_earnings, 2); ?></h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="premium-card p-4 bg-white border-0 shadow-sm" style="border-radius: 20px;">
                    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                        <h5 class="fw-bold mb-0">Full Transaction Log</h5>
                        <div>
